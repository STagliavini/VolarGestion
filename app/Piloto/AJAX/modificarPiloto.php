...
$validator = new ValidadorPiloto($piloto->getId_piloto(), $piloto->getDni_piloto(), $piloto->getApellido_piloto(), $piloto->getNombre_piloto(),$fecha,$piloto->getMail_piloto(),$piloto->getDeuda_piloto());
