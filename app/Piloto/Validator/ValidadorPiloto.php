...
class ValidadorPiloto {
    ...
    private $error_mail_piloto;
    private $error_deuda_piloto;
    ...
    function __construct($id_piloto, $dni_piloto, $apellido_piloto, $nombre_piloto, $nacimiento_piloto,$mail_piloto,$deuda_piloto) {
        ...
        $this->mail_piloto = "";
        $this->deuda_piloto=$this->validar_deuda_piloto($deuda_piloto);
        ...
        $this->error_mail_piloto = $this->validar_mail_piloto($mail_piloto);
    }
    ...
    function getError_deuda_piloto() {
        if ($this->error_deuda_piloto != "") {
            return $this->aviso_inicio . $this->error_deuda_piloto . $this->aviso_cierre;
        }
    }
    function getError_mail_piloto() {
        if ($this->error_mail_piloto != "") {
            return $this->aviso_inicio . $this->error_mail_piloto . $this->aviso_cierre;
        }
    }
    ...
    function setError_deuda_piloto($error_deuda_piloto) {
        $this->error_deuda_piloto = $error_deuda_piloto;
    }
    function setError_mail_piloto($error_mail_piloto) {
        $this->error_mail_piloto = $error_mail_piloto;
    }
    ...
    public function validar_deuda_piloto($deuda_piloto){
        if(!$this->variable_iniciada($deuda_piloto)||$deuda_piloto==0){
            return 0;
        }
        else{
            return $deuda_piloto;
    ...
    public function validar_mail_piloto($mail_piloto){
        if($this->variable_iniciada($mail_piloto)){
            if(!filter_var($mail_piloto,FILTER_VALIDATE_EMAIL)){
