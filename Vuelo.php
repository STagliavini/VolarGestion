    ...
    <?php
            ...
            <div class="main-panel">
                <div class="content">
                    <div class="page-inner">
                        ...
                        <h3><b>FORMULARIO DE VUELOS</b></h3>
                        <p class="mb-30 mr-100 mr-sm-0">Ingrese los datos de los vuelos</p>
        ...
        <script>
            $(document).ready(function () {
                $('#formu').load('vistas/Formu_Vuelo/formu_vuelo.php');
            ...
            function verificar(id_vuelo) {
                $.ajax({
                    url: "app/Vuelo/AJAX/modificarVuelo.php",
                    type: 'POST',
            ...
            function eliminar(id_vuelo) {
                if (confirm('Desea confirmar el borrado del vuelo?')) {
                    $.ajax({
                        url: "app/Vuelo/AJAX/borrarVuelo.php",
                        type: 'POST',
                        data: "id_vuelo=" + id_vuelo,
                        success: function (res) {
                            $('#formu').html(res);
            ...
            function cambiar(pagina) {
                ...
                if (modobusc > 0) {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: "pagina=" + pagina + "&fecha_vuelo=" + document.getElementById('fecha_vuelo').value + "&salida_vuelo=" + document.getElementById('salida_vuelo').value + "&llegada_vuelo=" + document.getElementById('llegada_vuelo').value + "&origen_vuelo=" + document.getElementById('origen_vuelo').value + "&destino_vuelo=" + document.getElementById('destino_vuelo').value + "&aterrizajes_vuelo=" + document.getElementById('aterrizajes_vuelo').value + "&piloto_vuelo=" + document.getElementById('piloto_vuelo').value + "&copiloto_vuelo=" + document.getElementById('copiloto_vuelo').value + "&avion_vuelo=" + document.getElementById('avion_vuelo').value+"&largo="+document.getElementById("largo").value,
                        success: function (res) {
