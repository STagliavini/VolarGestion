    ...
    <?php
            ...
            <div class="main-panel">
                <div class="content">
                    <div class="page-inner">
                        ...
                        <h3><b>FORMULARIO PILOTOS</b></h3>
                        <p class="mb-30 mr-100 mr-sm-0">Ingrese los datos de los pilotos</p>
        ...
        <script>
            $(document).ready(function () {
                $('#formu').load('vistas/Formu_Piloto/formu_piloto.php');
            ...
            function verificar(id_piloto) {
                $.ajax({
                    url: "app/Piloto/AJAX/modificarPiloto.php",
                    type: 'POST',
            ...
            function eliminar(id_piloto) {
                if (confirm('Desea confirmar el borrado del piloto?')) {
                    $.ajax({
                        url: "app/Piloto/AJAX/borrarPiloto.php",
                        type: 'POST',
                        data: "id_piloto=" + id_piloto,
                        success: function (res) {
                            $('#formu').html(res);
            ...
            function cambiar(pagina) {
                ...
                if (modobusc > 0) {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: "pagina=" + pagina + "&dni_piloto=" + document.getElementById("dni_piloto").value + "&apellido_piloto=" + document.getElementById("apellido_piloto").value + "&nombre_piloto=" + document.getElementById("nombre_piloto").value +"&nacimiento_piloto=" + document.getElementById("nacimiento_piloto").value+"&mail_piloto="+document.getElementById("mail_piloto").value+"&largo="+document.getElementById("largo").value,
                        success: function (res) {
