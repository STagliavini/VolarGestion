...
<div class="row">
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <select name="avion_vuelo" id="avion_vuelo" class="form-control">
    ...
    <div class="col-sm-6">							
        ...
        <div class="pos-relative">
            <input type="text" name="fecha_vuelo" id='fecha_vuelo'/>
    ...
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <input class="pr-20" type="text" name="salida_vuelo" id="salida_vuelo"/>
            <i class="dplay-none abs-tbr lh-35 font-13 color-green ion-android-done"></i>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <input class="pr-20" type="text" name="llegada_vuelo" id="llegada_vuelo"/>
            <i class="dplay-none abs-tbr lh-35 font-13 color-green ion-android-done"></i>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <input class="pr-20" type="text" name="origen_vuelo" id="origen_vuelo"/>
            <i class="dplay-none abs-tbr lh-35 font-13 color-green ion-android-done"></i>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <input class="pr-20" type="text" name="destino_vuelo" id="destino_vuelo"/>
            <i class="dplay-none abs-tbr lh-35 font-13 color-green ion-android-done"></i>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <select name="piloto_vuelo" id="piloto_vuelo" class="form-control" >
    ...
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <select name="copiloto_vuelo" id="copiloto_vuelo" class="form-control">
    ...
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <input class="pr-20" type="text" name="aterrizajes_vuelo" id="aterrizajes_vuelo"/>
            <i class="dplay-none abs-tbr lh-35 font-13 color-green ion-android-done"></i>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">
...
<script>
    $(document).ready(function () {
        $('#avion_vuelo').load('app/Vuelo/AJAX/SpinnerAvion.php');
        $('#piloto_vuelo').load('app/Vuelo/AJAX/SpinnerPiloto.php');
        $('#copiloto_vuelo').load('app/Vuelo/AJAX/SpinnerCopiloto.php');
