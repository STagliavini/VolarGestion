...
<div class="row">
    <div class="col-sm-6">	
        ...
        <div class="pos-relative">
            <input class="pr-20" type="password" name="nueva_contrasenia" id="nueva_contrasenia" value="<?php echo $validator->getNueva_contrasenia(); ?>"/>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">							
        <p class="color-ash">Repetir Contrasenia</p>
        <div class="pos-relative">
            <input type="password" name="repetir_contrasenia" id='repetir_contrasenia' value="<?php echo $validator->getRepetir_contrasenia(); ?>"/>
            <i class="dplay-none abs-tbr lh-35 font-13 color-green ion-android-done"></i>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">
        <?php echo $validator->getError_nueva_contrasenia(); ?>
    </div>
    <div class="col-sm-6">
        <?php echo $validator->getError_repetir_contrasenia(); ?>
    </div>
    <div class="col-sm-12">
        <?php echo $validator->getError_general(); ?>
    </div>
    <div class="col-sm-6">
