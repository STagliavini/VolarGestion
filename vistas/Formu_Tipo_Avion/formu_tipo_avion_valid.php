...
<div class="row">
    <input type="hidden" name="id_tipo_avion" value="<?php echo $validator->getId_tipo_avion(); ?>"/>
    <div class="col-sm-6">	
        <p class="color-ash">Nombre del Tipo de Avion*</p>
        <div class="pos-relative">
            <input class="pr-20" type="text" id='nombre_tipo_avion' name="nombre_tipo_avion" value="<?php echo $validator->getNombre_tipo_avion() ?>" <?php
            if ($validator->getId_tipo_avion() != -1) {
                echo 'readonly';
            }
            ?>/>
        </div><!-- pos-relative -->
    ...
    <div class="col-sm-6">							
        ...
        <div class="pos-relative">
            <input type="text" name="precio_tipo_avion" id='precio_tipo_avion' value="<?php echo $validator->getPrecio_tipo_avion(); ?>"/>
            <i class="dplay-none abs-tbr lh-35 font-13 color-green ion-android-done"></i>
        </div><!-- pos-relative -->
    </div><!-- col-sm-6 -->
    <div class="col-sm-6">
        <?php echo $validator->getError_nombre_tipo_avion(); ?>
    </div>
    <div class="col-sm-6">
        <?php echo $validator->getError_precio_tipo_avion(); ?>
    </div>
    <div class="col-sm-6">
