    ...
    <?php
            ...
            <div class="main-panel">
                <div class="content">
                    <div class="page-inner">
                        ...
                        <h3><b>FORMULARIO PAGOS</b></h3>
                        <p class="mb-30 mr-100 mr-sm-0">Ingrese los datos de los pagos</p>
        ...
        <script>
            $(document).ready(function () {
                $('#formu').load('vistas/Formu_Pago/formu_pago.php');
            ...
            function eliminar(id_pago) {
                if (confirm('Desea confirmar el borrado del pago?')) {
                    $.ajax({
                        url: "app/Pago/AJAX/borrarPago.php",
                        type: 'POST',
                        data: "id_pago=" + id_pago,
                        success: function (res) {
                            $('#formu').html(res);
