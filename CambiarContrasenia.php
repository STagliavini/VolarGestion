    ...
    <?php
        ...
        <script>
            $(document).ready(function () {
                $('#formu').load('vistas/Formu_Cambiar_Contrasenia/formu_cambiar_contrasenia.php');
            });
            function paginar() {
            ...
            function cambiar(pagina) {
                ...
                if (modobusc > 0) {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: "pagina=" + pagina + "&matricula_avion=" + document.getElementById("matricula_avion").value + "&nombre_avion=" + document.getElementById("nombre_avion").value + "&descripcion_avion=" + document.getElementById("descripcion_avion").value + "&tipo_avion=" + document.getElementById("tipo_avion").value,
                        success: function (res) {
